  ...
  return (
    <span className="inline-flex items-center gap-1">
      ...
      <motion.span
        ...
        className="inline-block w-0.5 h-7 bg-white/60 ml-0.5 translate-y-0.5"
      />
    </span>
  );
}
...
function ProjectsButton({ label }: { label: string }) {
  ...
  return (
    <motion.a
      ...
      className="relative flex items-center justify-center gap-3 bg-white text-black text-base font-medium rounded-full px-8 h-14 cursor-pointer"
...
function CVButton({ label }: { label: string }) {
  ...
  return (
    <motion.a
      ...
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      className="relative flex items-center justify-center gap-3 rounded-full px-8 h-14 overflow-hidden cursor-pointer border transition-colors duration-300"
      style={{
        minWidth: "200px",
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-5 max-w-4xl w-full">
        ...
        <motion.div
          {...fadeUp(0)}
          style={{ minWidth: "180px", minHeight: "30px" }}
          className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 backdrop-blur-sm"
        >
        ...
        <motion.h1
          {...fadeUp(0)}
          className="text-7xl sm:text-8xl md:text-9xl font-bold text-white tracking-tight leading-none whitespace-nowrap"
        >
          Fernando Guevara
        </motion.h1>
        ...
        <motion.p
          {...fadeUp(1)}
          className="text-2xl sm:text-3xl text-white/70 font-light leading-snug max-w-2xl"
        >
          {t("description")}
        </motion.p>
        ...
        <motion.div
          {...fadeUp(2)}
          className="flex items-center gap-2 text-white text-base tracking-widest uppercase font-light"
        >
